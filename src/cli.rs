...
pub struct SelfUpdateArgs {
    /// Update to the specified version. If omitted, forge updates to the latest version.
    pub target_version: Option<String>,
    /// A GitHub token for authentication to reduce rate-limit failures
    #[arg(long, env = "GITHUB_TOKEN")]
    pub token: Option<String>,
    /// Check what would happen without performing the update
    #[arg(long, action = ArgAction::SetTrue)]
    pub dry_run: bool,
}
